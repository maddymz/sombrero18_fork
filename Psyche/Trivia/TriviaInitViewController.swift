...
class TriviaInitViewController: UIViewController {
    ...
    func screenLayout(){
        ...
        if UIDevice.current.screenType == .iPhone_XR{
            ...
            mainView.bottomAnchor.constraint(equalTo: guide.bottomAnchor, constant: -330).isActive = true
            ...
            mainView.trailingAnchor.constraint(equalTo: guide.trailingAnchor, constant: -70).isActive = true
            mainView.topAnchor.constraint(equalTo: guide.topAnchor, constant: 205).isActive = true
            mainView.bottomAnchor.constraint(equalTo: guide.bottomAnchor, constant: -230).isActive = true
