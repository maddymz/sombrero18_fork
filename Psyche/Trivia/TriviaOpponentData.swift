...
class Opponents{
    ...
    init(){
        ...
        opponents.append(Opponent(name: "Carl Sagan", difficulty: 3, highScore: 945, lockedImage: #imageLiteral(resourceName: "CarlSagan_Lock"), unlockedImage: #imageLiteral(resourceName: "CarlSaganGradient"), blurb: "Carl Sagan assembled the 1st physical messages sent into space: the Pioneer plaque & Golden Record.", quote: "Look again at that dot. That's here. That's home. That's us.",profession: "Astronomer", fname: "Carl", level: 6))
